...
insert into images (coordinates,gcs_full_path,gcs_tagged_path,status,tagger_user_id,validator_user_id,id) values ('[]','path4','tagged_path4','PENDING',null,null,'13bb0f73-7a13-48bc-7b7d-663243ca7e59');
insert into images (coordinates,gcs_full_path,gcs_tagged_path,status,tagger_user_id,validator_user_id,id) values ('[]','path5','tagged_path5','PENDING',null,null,'13bb0f73-7a13-48bc-bb7d-963243ca7e59');

insert into users (id, name, email, role) values ('13bb0f73-7a13-48bc-bb7d-663243ca7e59', 'test user', 'test@email.com', 'ADMIN');
